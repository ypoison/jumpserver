...
class WEBConfigRecords(models.Model):
    ...
    jid = models.UUIDField(null=True)
    platform = models.ForeignKey(Node, on_delete=models.CASCADE, null=True, verbose_name='平台')
    ...
    proxy_ip = models.GenericIPAddressField(max_length=32, null=True, verbose_name='代理IP')
    proxy_port = models.IntegerField(null=True, verbose_name='代理端口')
