...
class Node(OrgModelMixin):
    ...
    public_high_anti_node = models.ForeignKey("assets.Asset", blank=True, null=True, related_name='public_node_asset', on_delete=models.CASCADE, verbose_name='公共高防节点')
    private_high_anti_node = models.ForeignKey("assets.Asset", blank=True, null=True, related_name='private_node_asset', on_delete=models.CASCADE, verbose_name='私有高防节点')
